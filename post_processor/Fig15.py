...
def plot_fig15a(data1, data2):
    ...
    filtered_data = f0_1[f0_1['crack_length'] <= 90]
    ax.plot(filtered_data['t'], filtered_data['crack_length'], label=r'$f_{ij}=0$', ls="--", lw=2, color='black')
...
plot_fig15a('flex3.txt', 'flex4.txt')
